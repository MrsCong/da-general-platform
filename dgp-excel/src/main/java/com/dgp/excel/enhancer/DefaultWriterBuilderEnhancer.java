...
public class DefaultWriterBuilderEnhancer implements WriterBuilderEnhancer {
     ...
     */
    @Override
    public ExcelWriterBuilder enhanceExcel(ExcelWriterBuilder writerBuilder,
     ...
     */
    @Override
    public ExcelWriterSheetBuilder enhanceSheet(ExcelWriterSheetBuilder writerSheetBuilder,
                                                Integer sheetNo,
